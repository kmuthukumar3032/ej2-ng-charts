...
export class RowDirective extends ComplexBase<RowDirective> {
    ...
    */
    public border: any;
    /** 
    * The height of the row as a string in order to provide input as both like '100px' or '100%'.If specified as '100%, row will render to the full height of its chart.
    * @default 100%
    */
