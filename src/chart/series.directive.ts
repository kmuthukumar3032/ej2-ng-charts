...
export class SeriesDirective extends ComplexBase<SeriesDirective> {
    ...
    */
    public name: any;
    /** 
    * The opacity of the series.     * @default 1
    */
    public opacity: any;
    /** 
    * Specifies Query to select data from dataSource. This property is applicable only when the dataSource is `ej.DataManager`.     * @default null
    */
    public query: any;
    /** 
    ...
    */
    ...
    /** 
    * Specifies the series visibility.     * @default true
    */
    public visible: any;
    /** 
    * The stroke width for the series, which is applicable only for `Line` type series.     * @default 1
    */
    public width: any;
    /** 
    * The name of horizontal axis associated with the series. It requires `axes` of chart.     * ```html     * <div id='Chart'></div>     * ```     * ```typescript     * let chart: Chart = new Chart({     * ...     *     columns: [{ width: '50%' },     *               { width: '50%' }],     *     axes: [{     *                name: 'xAxis 1',     *                columnIndex: 1,     *            }],     *     series: [{     *                dataSource: data,     *                xName: 'x', yName: 'y',     *                xAxisName: 'xAxis 1',     *     }],     * });     * chart.appendTo('#Chart');     * ```     * @default null
    */
    public xAxisName: any;
    /** 
    * The DataSource field which contains the x value.     * @default ''
    */
    public xName: any;
    /** 
    * The name of vertical axis associated with the series. It requires `axes` of chart.     * ```html      * <div id='Chart'></div>     * ```     * ```typescript     * let chart: Chart = new Chart({     * ...     *     rows: [{ height: '50%' },     *            { height: '50%' }],     *     axes: [{     *                name: 'yAxis 1',     *                rowIndex: 1,     *            }],     *     series: [{     *                dataSource: data,     *                xName: 'x', yName: 'y',     *                yAxisName: 'yAxis 1'     *     }],     * });     * chart.appendTo('#Chart');     * ```     * @default null
    */
    public yAxisName: any;
    /** 
    * The DataSource field which contains the y value.     * @default ''
    */
    public yName: any;
